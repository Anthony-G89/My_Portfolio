        ...
        return (
            <div>
                <Container className="containerHolder">
                    <h1 className="Title text-center" style={{color:"red"}}> Contact Me</h1>
                    <hr />
                    <div className="email text-center" onClick={() => this.navigateToGoogle("https://www.google.com/")}>
                        <h3 style={{ color: "red" }} >Email:</h3><h2 className="myEmail">adguerrero1935@gmail.com</h2>

                    </div>
                    <div className="LinkedIn text-center" onClick={() => this.navigateToLinkedIn("https://www.linkedin.com/in/anthony-guerrero-63a3a8199/")} >
                        <h3 style={{ color: "red" }}>LinkedIn:</h3><h2 className="myLinkedIn"> https://www.linkedin.com/in/anthony-guerrero-63a3a8199/</h2>
                    </div>

                    <div className="Github text-center" onClick={() => this.navigateToGitHub("https://github.com/Anthony-G89")} >
                        <h3 style={{ color: "red" }}>Github:</h3><h2 className="myGitHub">https://github.com/Anthony-G89 </h2>
                    </div>
                </Container>
            </div>
